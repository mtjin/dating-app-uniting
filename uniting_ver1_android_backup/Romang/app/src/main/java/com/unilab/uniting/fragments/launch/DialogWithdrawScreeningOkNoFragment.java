...
public class DialogWithdrawScreeningOkNoFragment extends DialogFragment implements View.OnClickListener{
    ...
    public DialogWithdrawScreeningOkNoFragment() {
    }

    public static DialogWithdrawScreeningOkNoFragment getInstance(){
        DialogWithdrawScreeningOkNoFragment dialog = new DialogWithdrawScreeningOkNoFragment();
        return  dialog;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSubtitleTextView.setText(" 탈퇴를 진행하실 경우 입력하신 모든 데이터 삭제되어 복구할 수 없습니다. \n 계속 탈퇴 진행을 원하실 경우 아래의 빈칸에 \"동의합니다\"라고 적은 후 탈퇴 버튼을 눌러주세요.");
