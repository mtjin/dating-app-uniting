...
public class ProfileCardPagerAdapter extends FragmentStatePagerAdapter {

    private int tabCount;
    private ArrayList<String> imageUrlList;

    public ProfileCardPagerAdapter(FragmentManager fm, int tabCount, ArrayList<String> imageUrlList) {
        super(fm);
