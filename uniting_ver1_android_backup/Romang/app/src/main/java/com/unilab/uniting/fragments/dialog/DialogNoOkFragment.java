...
public class DialogNoOkFragment extends DialogFragment implements View.OnClickListener{
    ...
    public DialogNoOkFragment() {
    }

    public static DialogNoOkFragment getInstance(){
        DialogNoOkFragment dialog = new DialogNoOkFragment();
        return  dialog;
    }
        ...
        mOkTextView.setOnClickListener(new OnSingleClickListener() {
            ...
            public void onSingleClick(View v) {
                if (getDialog() != null && getDialog().isShowing()) {
                    DialogOkListener activity = (DialogOkListener) getActivity();
                    activity.ok();
                    dismiss();
                }
            }
